...
describe('cube-seal frustum', () => {
  ...
  it('replaces the Sentinel with a centered optical-glass seal', () => {
    ...
    expect(MOTION.corePulseAmt).toBeLessThanOrEqual(0.02)
    expect(MOTION.idleIntensity).toBeLessThanOrEqual(0.45)
    expect(MOTION.speakRippleGap).toBeGreaterThanOrEqual(MOTION.speakRippleLife)
